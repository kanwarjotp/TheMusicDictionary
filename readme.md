...
+ Will Drevo's [Blog](https://willdrevo.com/fingerprinting-and-audio-recognition-with-python/) on Audiofingerprinting and the [Dejavu Repo](https://github.com/worldveil/dejavu) that helped me start this project.
